...
-- Drop ALL existing policies (including any that might have been partially created)
...
DROP POLICY IF EXISTS "Mitglieder, admin and vorstand can view training sessions" ON public.training_sessions;
DROP POLICY IF EXISTS "Mitglieder, admin and vorstand can create training sessions" ON public.training_sessions;
DROP POLICY IF EXISTS "Admin and vorstand can delete all training sessions" ON public.training_sessions;
